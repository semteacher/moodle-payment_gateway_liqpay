...
/**
 * Privacy Subsystem implementation for paygw_liqpay.
 *
...
namespace paygw_liqpay\privacy;
 ...
 * Privacy Subsystem implementation for paygw_liqpay.
 *
 * @copyright  2021 Andrii Semenets <semteacher@gmail.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class provider implements \core_privacy\local\metadata\null_provider, paygw_provider {
    ...
    public static function export_payment_data(\context $context, array $subcontext, \stdClass $payment) {
        ...
        $subcontext[] = get_string('gatewayname', 'paygw_liqpay');
        $record = $DB->get_record('paygw_liqpay', ['paymentid' => $payment->id]);
    ...
    public static function delete_data_for_payment_sql(string $paymentsql, array $paymentparams) {
        ...
        $DB->delete_records_select('paygw_liqpay', "paymentid IN ({$paymentsql})", $paymentparams);
    }
}
